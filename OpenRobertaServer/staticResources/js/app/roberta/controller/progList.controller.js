define(["require", "exports", "require", "log", "util", "comm", "message", "progList.model", "userGroup.model", "program.model", "configuration.controller", "program.controller", "guiState.controller", "blockly", "jquery", "bootstrap-table"], function (require, exports, require, LOG, UTIL, COMM, MSG, PROGLIST, USERGROUP, PROGRAM, CONFIGURATION_C, PROGRAM_C, GUISTATE_C, Blockly, $) {
