define(["require", "exports", "message", "log", "util", "guiState.controller", "program.controller", "program.model", "blockly", "codeflask", "jquery"], function (require, exports, MSG, LOG, UTIL, GUISTATE_C, PROG_C, PROGRAM, Blockly, CodeFlask, $) {
