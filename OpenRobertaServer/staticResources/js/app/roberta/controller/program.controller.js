define(["require", "exports", "comm", "message", "log", "util", "guiState.controller", "robot.controller", "program.model", "user.model", "configuration.controller", "progCode.controller", "blockly", "jquery", "jquery-validate"], function (require, exports, COMM, MSG, LOG, UTIL, GUISTATE_C, ROBOT_C, PROGRAM, USER, CONFIGURATION_C, PROGCODE_C, Blockly, $) {
